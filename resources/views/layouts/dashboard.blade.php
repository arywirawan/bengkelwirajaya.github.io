    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <form action="/logout" method="POST" id="submit">
                    @csrf
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="#" onclick="myFunction()" class="nav-link">
                            Logout
                        </a>
                    </li>
                </form>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <span class="brand-text">Bengkel Las Wira Jaya</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2022 <a href="\">Bengkel Las Wira Jaya</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
